...
class UserFav(models.Model):
    ...
    用户收藏操作
    """
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="用户", related_name="userid")
    foods = models.ForeignKey(Foods, on_delete=models.CASCADE, verbose_name="商品", help_text="商品id")
